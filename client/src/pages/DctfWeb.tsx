...
export default function DctfWeb() {
  ...
  const [debitoFilter, setDebitoFilter] = useState("all");
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2">
              <span className="text-sm text-muted-foreground">DCTFWeb</span>
            </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 bg-background border rounded-lg px-3 py-2">
              ...
              <span className="text-sm text-muted-foreground">Todo dia 10</span>
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          <Card className="flex-1 min-w-[140px] bg-red-50 border-red-200">
            <CardContent className="flex items-center gap-3 p-4">
              ...
              <div>
                <p className="text-xs text-red-600 font-medium">Com Débito</p>
                <p className="text-xl font-semibold text-red-600">{stats.comDebito}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="flex-1 min-w-[140px] bg-green-50 border-green-200">
            <CardContent className="flex items-center gap-3 p-4">
              ...
              <div>
                <p className="text-xs text-green-600 font-medium">Com Crédito</p>
                <p className="text-xl font-semibold text-green-600">{stats.comCredito}</p>
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">DCTFWeb Mensal</p>
                  <p className="text-xs text-muted-foreground">Declaração de Débitos e Créditos Tributários Federais</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-lg font-semibold">{dctfwebStats?.declared || 0}/{dctfwebStats?.total || 0}</p>
                <p className="text-xs text-muted-foreground">Transmitidas</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-sm text-blue-800">
            Atenção: A DCTFWeb deve ser transmitida até o <strong>dia 10</strong> do mês subsequente. 
            Verifique se todos os dados do eSocial e EFD-Reinf estão corretos antes da transmissão.
          </p>
        </div>
        ...
        <div className="flex items-end justify-between gap-4">
          ...
          <div className="flex items-end gap-3">
            ...
            <div>
              ...
              <Select value={debitoFilter} onValueChange={setDebitoFilter}>
                <SelectTrigger className="w-36">
                  <SelectValue placeholder="Todos" />
                </SelectTrigger>
                <SelectContent>
            ...
            <Table>
              <TableHeader>
                <TableRow className="hover:bg-transparent">
                  ...
                  <TableHead className="font-medium">Transmissão</TableHead>
                  <TableHead className="font-medium">Débito/Crédito</TableHead>
                  ...
                  <TableHead className="font-medium">DARF</TableHead>
